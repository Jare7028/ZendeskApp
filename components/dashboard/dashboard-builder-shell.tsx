  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "absolute left-1/2 top-3 z-20 inline-flex h-8 max-w-max -translate-x-1/2 items-center gap-2 rounded-full border border-border/70 bg-background/95 px-3 text-[11px] font-medium text-foreground shadow-sm transition cursor-grab active:cursor-grabbing touch-none",
